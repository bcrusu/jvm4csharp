...
namespace jvm4csharp.java.util
{
	...
	public class WeakHashMap<K, V> : AbstractMap<K, V>, Map<K, V>
		...
		where V : IJavaObject
	{
		protected WeakHashMap(ProxyCtor p) : base(p) {}
		
		public WeakHashMap(Map<K, V> arg0) : base(ProxyCtor.I)
		{
			Instance.CallConstructor("(Ljava/util/Map;)V", arg0);
		}
		
		public WeakHashMap(int arg0) : base(ProxyCtor.I)
		{
			Instance.CallConstructor("(I)V", arg0);
		}
		
		public WeakHashMap(int arg0, float arg1) : base(ProxyCtor.I)
		{
			Instance.CallConstructor("(IF)V", arg0, arg1);
		}
		
		public WeakHashMap() : base(ProxyCtor.I)
		{
