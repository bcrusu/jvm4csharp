...
namespace jvm4csharp.java.util.concurrent.locks
{
	...
	public abstract partial class AbstractQueuedLongSynchronizer : AbstractOwnableSynchronizer, Serializable
	{
		...
		public int getWaitQueueLength(AbstractQueuedLongSynchronizer_.ConditionObject arg0)
		{
		...
		public Collection<Thread> getWaitingThreads(AbstractQueuedLongSynchronizer_.ConditionObject arg0)
		{
		...
		public bool hasWaiters(AbstractQueuedLongSynchronizer_.ConditionObject arg0)
		{
		...
		[JavaSignature("(Ljava/util/concurrent/locks/AbstractQueuedLongSynchronizer/ConditionObject;)Z")]
		public bool owns(AbstractQueuedLongSynchronizer_.ConditionObject arg0)
		{
	...
	public static partial class AbstractQueuedLongSynchronizer_
	{
