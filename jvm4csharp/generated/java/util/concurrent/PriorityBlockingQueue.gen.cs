...
{
	[JavaProxy("java/util/concurrent/PriorityBlockingQueue")]
	public partial class PriorityBlockingQueue<E> : AbstractQueue<E>, BlockingQueue<E>, Serializable
		where E : IJavaObject
	{
		protected PriorityBlockingQueue(ProxyCtor p) : base(p) {}
		
		public PriorityBlockingQueue(Collection<E> arg0) : base(ProxyCtor.I)
		{
			Instance.CallConstructor("(Ljava/util/Collection;)V", arg0);
		}
		
		public PriorityBlockingQueue(int arg0, Comparator<IJavaObject> arg1) : base(ProxyCtor.I)
		{
			Instance.CallConstructor("(ILjava/util/Comparator;)V", arg0, arg1);
		}
		
		public PriorityBlockingQueue(int arg0) : base(ProxyCtor.I)
		{
			Instance.CallConstructor("(I)V", arg0);
		}
		
		public PriorityBlockingQueue() : base(ProxyCtor.I)
		{
