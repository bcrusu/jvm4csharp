...
namespace jvm4csharp.java.util.concurrent
{
		...
		where E : IJavaObject
	{
		...
		public LinkedTransferQueue() : base(ProxyCtor.I)
		{
			Instance.CallConstructor("()V");
		}
		
		public LinkedTransferQueue(Collection<E> arg0) : base(ProxyCtor.I)
		{
		...
		{
			return Instance.CallMethod<int>("getWaitingConsumerCount", "()I");
		}
		
		[JavaSignature("()Z")]
		public bool hasWaitingConsumer()
		{
			return Instance.CallMethod<bool>("hasWaitingConsumer", "()Z");
		}
		
		[JavaSignature("(Ljava/lang/Object;)Z")]
		public bool tryTransfer(E arg0)
		{
			return Instance.CallMethod<bool>("tryTransfer", "(Ljava/lang/Object;)Z", arg0);
		}
